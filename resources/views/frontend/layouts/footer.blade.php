                        ...
                        <div class="module-body">
                            <ul class="toggle-footer" style="">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>+{{ $cpmpanyInfo->comp_phone1 }}<br>+{{ $cpmpanyInfo->comp_phone2 }} </p>
                                    </div>
                                </li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            ...
                            <li class="last"><a href="#" title="Send us feedback"> {{  $cpmpanyInfo->comp_email1 }} </a></li>
                        </ul>
                    </div><!-- /.module-body -->
                </div><!-- /.col -->
                @endforeach
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-padding social">
                <ul class="link">
                    ...
                    <li class="whatsapp pull-left"><a target="_blank" rel="nofollow" href="#"
                            title="WahtsApp"></a></li>
